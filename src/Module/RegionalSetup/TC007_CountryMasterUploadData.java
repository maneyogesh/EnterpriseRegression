...
import pom.ObjectPages.uiActions.CountryMaster;
...
public class TC007_CountryMasterUploadData extends TestBase {

	public static final Logger log = Logger.getLogger(TC007_CountryMasterUploadData.class.getName());
	...
	@DataProvider(name="CountryMasterData")
	public String[][] getTestData(){
		String[][] testRecords = getData("CountryMaster.xlsx", "CountryMaster");
		return testRecords;
	}
	...
	@Test(priority=3,dependsOnGroups = {"CMAddNewButton"},dataProvider="CountryMasterData")
	public void Data_Upload(String CountryCodeData, String CountryNameData, String TimeDifferenceData, String statusData) throws Exception {
		bc = new BaseClass(driver);
		cm = new CountryMaster(driver);
				/*  if(Mode.equalsIgnoreCase("n")){
				throw new SkipException("user marked this record as no run");
			}*/
		cm.Test_AddNewDataUpload(CountryCodeData, CountryNameData, TimeDifferenceData, statusData);
