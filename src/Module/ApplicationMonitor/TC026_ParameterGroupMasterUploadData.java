...
import pom.ObjectPages.uiActions.ParameterGroupMaster;
...
public class TC026_ParameterGroupMasterUploadData extends TestBase {

	public static final Logger log = Logger.getLogger(TC026_ParameterGroupMasterUploadData.class.getName());
	private String sTestCaseNdme;
	private int iTestCaseRow;
	EntityMaster em;
	ParameterGroupMaster pgm;
	BaseClass bc;
	TestBase tb;
	
	@DataProvider(name="ParameterGroupMasterData")
	public String[][] getTestData(){
		String[][] testRecords = getData("ParameterGroupMaster.xlsx", "ParameterGroupMaster");
		return testRecords;
	}
	...
	public void Target_Page() throws Exception{
		pgm = new ParameterGroupMaster(driver);
		pgm.Test_Open_Target_Page();
	}
		
	@Test(priority=2,groups="pgmAddNewButton",dependsOnGroups = {"pgmTargetPage"})
	public void AddNew_Button(){
		pgm = new ParameterGroupMaster(driver);
		pgm.Test_AddNew_Button();
	}
	
	@Test(priority=3,dependsOnGroups = {"pgmAddNewButton"},dataProvider="ParameterGroupMasterData")
	public void Data_Upload(String ParameterGroupCodedata, String ParameterGroupNamedata, String ActiveData) throws Exception {
		...
		pgm.Test_AddNewDataUpload(ParameterGroupCodedata, ParameterGroupNamedata, ActiveData);
			String AlertMsg = bc.closeAlertAndGetItsText();
		 try {
			 Assert.assertEquals(AlertMsg, "Data saved Successfully");
			...
			getScreenShot("Parameter Group Master");
	...
	@Test(priority=4,dependsOnGroups = {"pgmAddNewButton"})
